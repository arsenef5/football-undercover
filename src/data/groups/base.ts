...
/**
 * Base gratuite : des groupes de mots proches, connus mondialement.
...
export const BASE: GroupDef[] = [
  ...
  /* Les Bleus par poste, toutes époques mélangées : Pavard tombe aussi bien avec Desailly qu'avec Umtiti. */
  ...
  /* ------------------------------------------------------------------ */
  {
    /* Tous les championnats ensemble : l'undercover peut tomber sur n'importe quel pays. */
    cat: 'competition',
    words: [
      'Premier League',
      ['Liga', 'La Liga'],
